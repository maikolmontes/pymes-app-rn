  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {/* ODS */}
        <TouchableOpacity style={styles.odsButton} onPress={() => navigation.navigate('ODS')}>
          <Text style={styles.odsText}>
            Conoce cómo apoyamos los Objetivos de Desarrollo Sostenible
          </Text>
